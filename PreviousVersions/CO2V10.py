...
def rheometerPlate(x,y):
    ...
    zeroShear = 1
    concentration = concentrationSln(r1,t1,R,a_n,D)
...
bc = dde.DirichletBC(geomtime, lambda x: 0, inside)
bc2 = dde.DirichletBC(geomtime, lambda x: torqueOut, outside)
bc3 = dde.NeumannBC(geomtime, lambda x: 0, inside)
